...
public class UserInterfaceFrm extends javax.swing.JFrame {

    public UserInterfaceFrm() {
        initComponents();
        ...
        jLabel13.setText(Client.user.getUserName());
        jLabel19.setText(Integer.toString(Client.user.getNumberOfwin()));
        jLabel17.setText(Integer.toString(Client.user.getNumberOfGame()));
        jLabel21.setText(Integer.toString(Client.user.getNumberOfDraw()));
        String avt = Client.user.getAvatar();
        avt = avt.trim();
        jLabel8.setIcon(new ImageIcon("assets/avatar/"+avt+".jpg"));
        
        if(Client.user.getNumberOfGame()==0){
            jLabel23.setText("-");
        }
        else{
            float rate = (((float)Client.user.getNumberOfwin()*100)/Client.user.getNumberOfGame());
            jLabel23.setText(String.format("%.2f", rate));
//            jLabel23.setText(String.format("%.2f", (float)(Client.user.getNumberOfwin()/Client.user.getNumberOfGame())*100)+"%");
        }
    ...
    private void initComponents() {
        ...
        jLabel14.setText("Số ván đã chơi:");

        jLabel17.setText("{NumOfGame}");

        jLabel18.setText("Số ván thắng");

        jLabel19.setText("{NumOfWin}");

        jLabel20.setText("Số ván hòa");

        jLabel21.setText("{NumOfDraw}");

        jLabel22.setText("Tỉ lệ thắng trận:");

        jLabel23.setText("{RateWin}");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try {
            Client.closeView(Client.View.USERINTERFACE);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Client.openView(Client.View.JOINROOMPASS);
